...
<div class="group-select form-group clearfix">
    <label class="col-sm-2 control-label" style="">小组选择：</label>
    <div class="col-sm-10 clearfix">
        <a class="btn btn-default group-select"  data-group="1" data-action="groupSelect">前端</a>
        <a class="btn btn-default group-select"  data-group="2" data-action="groupSelect">视觉</a>
        <a class="btn btn-default group-select"  data-group="3" data-action="groupSelect">交互</a>
    </div>
</div>